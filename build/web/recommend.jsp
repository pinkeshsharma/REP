<%-- 
    Document   : recommend
    Created on : Sep 26, 2015, 1:26:07 AM
    Author     : Dimple
--%>
...
<div class="inline">
    <div class="top_page">
        <span class="bck_grey"> Recommend to a friend </span>
    </div>
    <div class="top_breadcrum">
        <a href="<%=request.getContextPath() + "/controller?action=home"%>" class="text_150">&#9754; Back to main page</a>
    </div>
</div>
        <form action="<%=request.getContextPath() + "/studycontroller?action=confirmr"%>" method="POST" class="signup_center">
            <ul>
            ...
            <ul>
                <li class="inline"><label >Friend's Email*</label></li>
                <li class="inline"><input class="login_input" placeholder="Email" type="email" size="40" name="friends_email" required /><br></li>
            </ul>
            <ul>
